...
def signup(request):
    ...
    json2 = open('User/user_data.json',) 
    ...
    if email not in emails:
        ...
        return render(request, 'User.register.html', {'loc':report_loc,'errorclass':'alert alert-danger','error': 'Sorry. The Username or Email ID is already taken.'})